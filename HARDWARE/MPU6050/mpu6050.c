...
u8 MPU_Get_Gyroscope(short *gx,short *gy,short *gz)
{
	...
	if(res==0)
	{
//		*gx=((u16)buf[0]<<8)|buf[1];{0.02, 0, 0, 0, 0.001, 0.543};
...
//		*az=((u16)buf[4]<<8)|buf[5];
		*ax= tBuff[0] = tBuff[0] * (1 - factor) + *ax * factor;
		*ay= tBuff[1] = tBuff[1] * (1 - factor) + *ay * factor;
		*az= tBuff[2] = tBuff[2] * (1 - factor) + *az * factor;
